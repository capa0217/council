...
useEffect(() => {
  ...
  const BoardMembers = names.filter(n => n.guest != 1 && n.access == "council")
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.containers}>
               <View>
                     ...
                     <View>
                        <TouchableOpacity style={styles.buttons} onPress={()=>router.push("./AssociationBoardMembers")}><Text style={styles.name}>Club Board Members</Text></TouchableOpacity>
                     </View>
                     <View>
