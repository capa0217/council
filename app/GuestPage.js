...
export default function GuestPage(){
 ...
 useEffect(() => {
  ...
  console.log(userId);
     useEffect(() => {
  axios.get('http://192.168.1.110:8081/clubs')
  ...
  <TouchableOpacity  style={styles.meetingBlock}  key={index}
        onPress={() => handlePress(club.Club_id)}><Text>{club.Club_name}</Text></TouchableOpacity>
))}
