 ...
 useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.label}>Club id: <Text style={styles.value}>{clubs[0].Club_id}</Text></Text>
      <Text style={styles.label}>Club Name: <Text style={styles.value}>{clubs[0].Club_name}</Text></Text>
      <Text style={styles.label}>Club Status: <Text style={styles.value}>{clubs[0].status}</Text></Text>
       <TouchableOpacity onPress={()=>sendMessage(UserId)}><Text>Join</Text></TouchableOpacity>
    </View>
  );
};
